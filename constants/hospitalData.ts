...
export const HOSPITALS: Hospital[] = [
  ...
  },
  {
    ...
    phone: '02-2258-1534',
    address: '서울시 종로구 대학로 90길 24 (외과 빌딩 2층)',
    intro: '건강한외과의원은 급성 충수염(맹장염), 탈장 및 피부 양성 종양 절제 등 다양한 복강경 소수술과 외상 염증 상처 치료 전문 의원입니다.',
    doctors: [
      {
        name: '윤지훈',
        role: '대표원장/외과전문의',
        intro: '신속하고 안전한 외과 소수술 및 외상 상처 케어를 제공합니다.',
        bio: ['서울대학교 의과대학 졸업', '일반외과 전문의 자격 취득', '대한외과학회 평생회원', '前 서울대병원 외과 전공의 수료', '대한의사협회 정회원']
      },
      {
        name: '민아름',
        role: '부원장/외과전문의',
        intro: '충수돌기염 및 탈장 등 급성 복강경 소수술 전문의입니다.',
        bio: ['순천향대학교 의과대학 졸업', '순천향대병원 외과 전임의 수료', '대한대장항문학회 정회원', '대한의사협회 정회원']
      }
    ]
  },
  {
